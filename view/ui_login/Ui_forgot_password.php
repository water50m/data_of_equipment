...
if($_POST["email"]){
    ...
    header('Location:..\..\module\login\send_mail.php');
    exit();
}
?>
                        ...
                        <div class="panel-body ">
                            <div class="text-center">
                                ...
                                <form action="" id="register-form" role="form" autocomplete="off" class="form" method="post">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Sent OTP</button>
                                </form>
