...
// $sql1  = "SELECT * FROM equipment_inspection_report WHERE id = '$idpro'";
...
<?php include '../navbar/navbar.php'; ?>
    ...
    <div class="container ">
        <div class="row">
            <div class="col">
            <div class="alert h4 text-center alert-warning mt-4 md-4" role="alert">Clone data</div>
          ...
          <div class="row">
            <div class="col">
                  <input type="hidden" id="input1"  name="id" class="form-control" value="<?=$row['id']?>" required ><br>
                    ...
                    <div class="bottom " >
                    <button type="submit" class="btn btn-success mt-4">Save new</button>
